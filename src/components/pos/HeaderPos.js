            ...
            <Navbar bg="light" expand="lg" className='pos_header'>
                <Container fluid>
                    <div className='custom_name navbar-brand'>
                        <Link to="#" className='pos_hamburger'><Icon icon="icon-park-outline:hamburger-button" /></Link>
                        <div className='posSidebar'>
                            <ul>
                                <li>One</li>
                                <li>Two</li>
                            </ul>
                        ...
                        <div className='PosModal'>
                            <Link Link to="#" variant="primary" onClick={handleShow}>
                                {posName}
                            </Link>
                    ...
                    <Navbar id="basic-navbar-nav" className='justify-content-end'>
                        <Nav className="">
                            <Nav.Link to="/" className='cus_pos_nav'><Icon icon="mdi:monitor-dashboard" /> <span>Dashboard</span></Nav.Link>
                            <Nav.Link to="/" className='cus_pos_nav'><Icon icon="mdi:home-outline" /> <span>Home</span></Nav.Link>
                            <Nav.Link to="/" className='cus_pos_nav'><Icon icon="mdi:lock-outline" /> <span>Lock</span></Nav.Link>
                            <Nav.Link to="/" className='cus_pos_nav'><Icon icon="lucide:refresh-cw" /> <span>Refresh</span></Nav.Link>
                            <Nav.Link to="/" className='cus_pos_nav cus_pos_login'><Icon icon="fad:powerswitch" /></Nav.Link>
                        </Nav>
                    </Navbar>
                </Container>
            </Navbar>
