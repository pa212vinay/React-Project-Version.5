        ...
        <Row className='g-3'>
          ...
          <div className="col-lg-6 col-md-6 col-xl-6 col-xxl-6 ">
              ...
              <h6 className='fw-bold'>corcrmuser1@gmail.com</h6>
                ...
                <ul class="list-inline mb-0 p-2">
                  ...
                  <li class="list-inline-item"><span className='fw-bold text-wrap'>Email - </span>corcrmuser1@gmail.com</li>
                </ul>
                <ul class="list-inline mb-0 p-2">
          ...
          <div className='row mt-3 g-3'>
            ...
            <div class="float-end mb-2">
              <button class="btn-hover color-1 me-2">Reset</button>
            <button class="btn-hover color-3 r_mt-2">Merge</button>
            </div>
            </div>
          </div>
        </Row>
