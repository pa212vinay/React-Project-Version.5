    ...
    return (
        <div className="container-flude p-3">
            <div className="bg_col Admin_tab p-3">
                <Tab_One />
                <div className="tab_center p-3 mt-3">
                    <Row className="g-3">
                        <h4>Owner Information</h4>
                        <div className="col-md-6 col-sm-12">
                            <div className="form-group cus-form-group">
                                <Form.Control placeholder="Name" className='fill-input' />
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> - </td>
                                            <td> - </td>
                                            <td className="text-center"> <div><Icon icon="pepicons-pencil:file" width="20" className="me-2" />Invoices</div> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <Row className="g-3 mt-3">
                        ...
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group cus-form-group">
                                ...
                                <label htmlFor="shipping" className='float-label'>Company Name</label>
                            </div>
                        </div>
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group cus-form-group">
                                <Form.Control placeholder="Business Address" className='fill-input' />
                                <label htmlFor="shipping" className='float-label'>Business Address</label>
                            </div>
                        </div>
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group cus-form-group">
                                <Form.Control placeholder="Business Address Line 2" className='fill-input' />
                                <label htmlFor="shipping" className='float-label'>Business Address Line 2</label>
                            </div>
                        </div>
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group cus-form-group">
                        ...
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group cus-form-group">
                                ...
                                <label htmlFor="shipping" className='float-label'>State</label>
                            </div>
                        </div>
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group cus-form-group">
                                <Form.Control placeholder="ZIP Code" className='fill-input' />
                                <label htmlFor="shipping" className='float-label'>ZIP Code</label>
                            </div>
                        </div>
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group cus-form-group">
                                <Form.Control placeholder="Customer Service Email" className='fill-input' />
                                <label htmlFor="shipping" className='float-label'>Customer Service Email</label>
                            </div>
                        </div>
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group cus-form-group">
                                <Form.Control placeholder="Customer Service Phone" className='fill-input' />
                                <label htmlFor="shipping" className='float-label'>Customer Service Phone</label>
                            </div>
                        </div>
                        <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div className="card">
                                <div className="card-body">
                                    <div className="card-title">Upload your file here</div>
                                    <div className="card-subtitle">Maximum file size is 1GB</div>
                                    <div className="file-upload">
                                        <input className="file-input" type="file" />
                                        <svg className="icon" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
