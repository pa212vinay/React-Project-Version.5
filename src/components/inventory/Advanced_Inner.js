...
const Advanced_Inner = () => {
    const [selected, setSelected] = useState(["Camra"]);
    return (
        <>
            <div className="p-3 bg_col pt-0 advanced">
                <Tab />
                <Row className='g-3 mt-1'>
                    <div className='col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div className='bg_col p-3'>
                            <div className='row'>
                                <div className='col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-3'>
                                    <span className='fw-bold'>Attributes</span>
                                    <span className='float-end'>Add new <button className='btn-icon color-3 py-2'><Icon icon="ic:round-plus" width={24}/></button></span>
                                </div>
                            </div>
                            <Row className='g-3'>
