            ...
            <div className="p-3 bg_col pt-0 product_details">
                ...
                <Row className='g-3 mt-1'>
                    <div className='col-xxl-9 col-xl-9 col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div className='bg_col p-3'>
                            <h6 className='fw-bold mb-4'>Basic Info</h6>
                            <Row className='g-3'>
                                <div className="col-xxl-2 col-xl-2 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div className="form-group cus-select-group">
                                        <Form.Control className="form-control fill-input" as="select" name="require_shipping">
                                            <option>17171</option>
                                            <option value="1">One</option>
                                ...
                                <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                    <div className='position-relative'>
                                        ...
                                        <div className='lable_icon' onClick={() => lable_click(true)}>
                                            <Icon icon="circum:barcode" width={20}/>
                                            <p>Label</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className='col-xxl-3 col-xl-3 col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        ...
                        <div className='bg_col p-3 mt-3  P_details'>
                            ...
                            <div className='text-end'>
                                <button class="btn-hover color-3 mt-2" onClick={() => set_add_category(!add_category)}><Icon icon="ic:round-plus" width={22}/> Add Category</button>
                            </div>
                        </div>
